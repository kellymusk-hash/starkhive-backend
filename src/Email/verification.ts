import { sendEmail } from "../auth/utils/utils.function"

export async function emailverification(payload: any) {

    const subject = `StarkHive ${payload.type} Verification code`
    const content =
        `
    <!DOCTYPE html>
<html>
...
<body>
    <table class="email-container">
        ...
        <tr>
            <td class="footer">&copy; 2025 StarkHive. All rights reserved.</td>
        </tr>
    </table>
</body>
</html>
